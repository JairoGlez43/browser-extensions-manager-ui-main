                ...
                <div className="container flex flex-col gap-2 sm:flex-row sm:justify-between items-center w-full">
                    ...
                    <div className="flex space-x-2">
                        {filterType.map(filter => 
                            (<Button key={filter} className={activeFilter===filter?"bg-[var(--red-500)] dark:bg-[var(--red-400)] hover:bg-[var(--red-400)] dark:hover:bg-[var(--red-500)] hover:border-0 text-[var(--neutral-100)] dark:text-[var(--neutral-900)] py-2 px-4 border-1 border-[var(--neutral-200)] dark:border-[var(--neutral-600)] rounded-full":"bg-[var(--neutral-0)] dark:bg-[var(--neutral-800)] border-1 border-[var(--neutral-200)] dark:border-[var(--neutral-600)] hover:bg-[var(--neutral-200)] dark:hover:bg-[var(--neutral-700)] text-[var(--neutral-900)] hover:text-[var(--neutral-600)] dark:text-[var(--neutral-100)] hover:border-0 py-2 px-4 rounded-full"} onClick={() => setActiveFilter(filter as typeof activeFilter)}>
                                {filter}
                            </Button>))
                        }
                    </div>
